...
11) After completion `ls /dev/serial/by-id/*` should return a device begining with `/dev/serial/by-id/usb-Klipper_stm32f042x6...` Copy this name and place it in your [mcu] section of the display config file.
